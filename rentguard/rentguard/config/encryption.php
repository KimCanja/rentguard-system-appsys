<?php
// config/encryption.php - AES-256-CBC Encryption Helper

// ==================== CONFIGURATION ====================
// Change this to a VERY strong secret key (at least 32 characters, random)
// Never commit this key to Git. Put it in an .env file in production.
