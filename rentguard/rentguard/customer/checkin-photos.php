...
$before_photos = array_filter($all_photos, fn($p) => $p['type'] === 'before');
$after_photos = array_filter($all_photos, fn($p) => $p['type'] === 'after');
?>
...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1><i class="fas fa-camera"></i> Check-In Photos</h1>
            <p class="text-muted">Upload photos of the vehicle after rental return</p>
        </div>
    </div>

    <div class="row">
        <div class="col-md-8">
            <!-- Before Photos Comparison -->
            <?php if (count($before_photos) > 0): ?>
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-check-circle"></i> Before Rental Photos</h5>
                    </div>
                    <div class="card-body">
                        <div class="photo-grid">
                            <?php foreach ($before_photos as $photo): ?>
                                <div class="photo-item">
                                    <img src="<?php echo BASE_URL . htmlspecialchars($photo['image_path']); ?>" alt="Before">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Upload After Rental Photos</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div class="mb-3">
                            <label class="form-label">Damage Notes (Optional)</label>
                            <textarea id="damageNotes" class="form-control" rows="3" placeholder="Note any damage or issues..."></textarea>
                        </div>
            ...
            <!-- After Photos Display -->
            <?php if (count($after_photos) > 0): ?>
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-check-circle"></i> After Rental Photos</h5>
                    </div>
                    <div class="card-body">
                        <div class="photo-grid">
                            <?php foreach ($after_photos as $photo): ?>
                                <div class="photo-item">
                                    <img src="<?php echo BASE_URL . htmlspecialchars($photo['image_path']); ?>" alt="After">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0">
                        <i class="fas fa-info-circle"></i> Please take clear photos of the vehicle's exterior and interior condition for comparison.
                    </p>
                </div>
            </div>
        </div>
